...
import { PeticionComponent } from 'app/entities/peticion/peticion.component';
...
describe('Component Tests', () => {
  describe('Peticion Management Component', () => {
    let comp: PeticionComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PeticionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.peticions && comp.peticions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
