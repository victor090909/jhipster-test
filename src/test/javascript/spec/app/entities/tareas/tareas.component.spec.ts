...
import { TareasComponent } from 'app/entities/tareas/tareas.component';
import { TareasService } from 'app/entities/tareas/tareas.service';
import { Tareas } from 'app/shared/model/tareas.model';

describe('Component Tests', () => {
  describe('Tareas Management Component', () => {
    let comp: TareasComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TareasComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.tareas && comp.tareas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
